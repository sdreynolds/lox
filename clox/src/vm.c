...
static bool call(ObjClosure* closure, int argCount) {
    if (argCount != closure->function->arity) {
        ...
        return false;
    } else if (vm.frameCount == FRAMES_MAX) {
    ...
    if (IS_OBJ(callee)) {
        ...
        case OBJ_CLASS: {
            ...
            if (tableGet(&klass->methods, vm.initString, &initializer)) {
                ...
                runtimeError("expected 0 arguments but go %d.",
                             argCount);
            }
            return true;
        }
        ...
        default: {
            runtimeError("Cannot call a %d", OBJ_TYPE(callee));
    ...
    for (;;) {
       ...
       case OP_SET_PROPERTY: {
        ...
        case OP_INHERIT: {
            ...
            // Adds the superclass methods *before* any of the subclass methods are added.
            // This means overridden methods in the subclass are added *after* and replace
